export default function EditDeleteBoard(props: {
  ...
  return (
    <ul
      onClick={() => props.setEditDeleteBoardIsActive(false)}
      className="fixed right-6 top-16 bg-very-dark-grey shadow-md rounded-lg flex flex-col items-start z-50 w-[200px] overflow-hidden"
    >
      <li
